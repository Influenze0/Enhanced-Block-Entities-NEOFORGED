...
public enum EBESetup {
    ...
    public static void setupChests() {
        EnhancedBlockEntityRegistry.register(Blocks.CHEST, BlockEntityType.CHEST, BlockEntityRenderCondition.NEVER, BlockEntityRendererOverride.NO_OP);
        EnhancedBlockEntityRegistry.register(Blocks.TRAPPED_CHEST, BlockEntityType.TRAPPED_CHEST, BlockEntityRenderCondition.NEVER, BlockEntityRendererOverride.NO_OP);
        EnhancedBlockEntityRegistry.register(Blocks.ENDER_CHEST, BlockEntityType.ENDER_CHEST, BlockEntityRenderCondition.NEVER, BlockEntityRendererOverride.NO_OP);
    }
    ...
    public static void setupSigns() {
        for (var sign : new Block[]{
            ...
            EnhancedBlockEntityRegistry.register(sign, BlockEntityType.SIGN, BlockEntityRenderCondition.SIGN, BlockEntityRendererOverride.SIGN_TEXT_ONLY);
        }
        for (var sign : new Block[]{
            ...
            EnhancedBlockEntityRegistry.register(sign, BlockEntityType.HANGING_SIGN, BlockEntityRenderCondition.SIGN, BlockEntityRendererOverride.SIGN_TEXT_ONLY);
        }
    }
    ...
    public static void setupShulkerBoxes() {
        for (DyeColor color : EBEUtil.DEFAULTED_DYE_COLORS) {
            ...
            EnhancedBlockEntityRegistry.register(block, BlockEntityType.SHULKER_BOX, BlockEntityRenderCondition.NEVER, BlockEntityRendererOverride.NO_OP);
        }
    }
